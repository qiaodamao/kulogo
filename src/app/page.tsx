    ...
    <div className="min-h-screen transition-colors duration-300">
      <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="relative min-h-[80vh] flex items-center justify-center mb-4 lg:mb-6 w-full mt-0">
          ...
          {/* 内容区域 */}
          <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8 pt-[150px] md:pt-[188px] pb-12">
            <div className="flex flex-col items-center gap-12 lg:gap-16">
              ...
              <div className="w-full max-w-3xl text-center">
                ...
                <div className="flex items-center justify-center">
                    <div className="flex items-center gap-3 px-6 py-3 bg-white/10 dark:bg-gray-800/30 backdrop-blur-md rounded-2xl shadow-[0_0_20px_rgba(0,0,0,0.03)] dark:shadow-[0_0_20px_rgba(0,0,0,0.25)] border border-white/30 dark:border-gray-700/30">
            ...
            {selectedLogos.size > 0 && (
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-[#06b30c] text-white rounded-full text-sm font-medium hover:bg-[#06b30c]/90 hover:shadow-[0_4px_12px_rgba(6,179,12,0.3)] transition-all duration-300"
                >
